...
conn = sqlite3.connect(r'E:\Fatonitech\research\db.sqlite3')
...
for province in Province:
    cursor.execute('INSERT INTO researchapp_province (id, code, name_th, name_en, zone_id) VALUES (?, ?, ?, ?,?)', province)
...
for district in District:
    cursor.execute('INSERT INTO researchapp_district (id, code, name_th, name_en, province_id) VALUES (?, ?, ?, ?,?)', district)
...
for subdistrict in SubDistrict:
    cursor.execute('INSERT INTO researchapp_subdistrict(id, zip_code, name_th, name_en, amphure_id) VALUES (?, ?, ?, ?,?)', subdistrict)

conn.commit()

print("SubDistrict inserted successfully.")


conn.close()

print("province inserted successfully.")